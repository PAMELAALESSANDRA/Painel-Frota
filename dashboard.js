...
const DATA = {
    jan: {
        ...
        fuelProducts: {
            labels: ["DIESEL S10", "DIESEL S10 ADITIVADA", "ARLA", "DIESEL S10 ADITIVADO", "DIESEL COMUM"], values: [187048, 6176, 4601, 2379, 1508], liters: [28807, 967, 1124, 372, 226],
            details: [
                { name: 'DIESEL S10', count: 200, liters: '28.807', value: '187.048' },
                { name: 'DIESEL S10 ADITIVADA', count: 5, liters: '967', value: '6.176' },
        ...
        maintTypesCount: { labels: ['COMBUSTIVEL', 'CORRETIVA', 'PNEU', 'PREVENTIVA', 'RECAPAGEM', 'ÓLEO MOTOR', 'Outros'], data: [200, 11, 9, 7, 5, 4, 12] },
        maintTypeDetails: [
            { name: 'COMBUSTIVEL', count: 200, value: '206.824' },
            { name: 'CORRETIVA', count: 11, value: '22.864' },
            { name: 'RECAPAGEM', count: 5, value: '8.860' },
            { name: 'PREVENTIVA', count: 7, value: '5.711' },
            { name: 'PNEU', count: 9, value: '5.190' },
            { name: 'ÓLEO MOTOR', count: 4, value: '2.782' },
            { name: 'ESTOQUE', count: 4, value: '1.146' },
            { name: 'CERTIFICADO', count: 1, value: '1.043' },
            { name: 'LAVAGEM', count: 1, value: '250' }
        ],
        suppliers: [
            { name: 'SEM PARAR', value: '117.945,80' },
            { name: 'SEM PARAR VIA FACIL', value: '84.560,09' },
            { name: 'SERGIPANA TRUCK CLIENTER', value: '7.460,00' },
            { name: 'ROSANGELA MARTINS DE ANDRADE-ME', value: '5.432,00' },
            { name: 'JAIME MENDONCA', value: '4.585,00' },
            { name: '52.913.524 JONATHAN ALVES DE OLIVEIRA', value: '3.500,00' },
            { name: '60.463.921 SAMUEL DA SILVA FERREIRA', value: '2.205,00' }
        ],
        topMaintVehicle: { plate: 'GFL3G04', value: '5.919,00' },
        ...
        trendData: [37042, 74084, 111126, 148168, 185210, 222252, 259294],
        weeklyMaint: [47398, 52974, 58550, 47398, 52974],
        weeklyFuel: [38000, 42000, 45000, 40000, 36712]
    },
    feb: {
        ...
        maintTypeDetails: [{ name: 'Nenhum registro em Fevereiro', count: 0, value: '0' }],
        suppliers: [{ name: 'Nenhum registro em Fevereiro', value: 'R$ 0,00' }],
        ...
        weeklyFuel: [34831, 38314, 41797, 34831, 38314]
    },
