...
const DATA = {
    ...
    feb: {
        ...
        fuel: { records: 247, liters: 26975.22, value: 169800.59, avgLiter: 6.29 },
    ...
    todos: {
        ...
        fuelProducts: {
            labels: ["DIESEL S10", "DIESEL S10 ADITIVADA", "ARLA", "DIESEL S10 ADITIVADO", "DIESEL COMUM"], values: [339505, 17141, 10979, 2379, 1508], liters: [52506, 2683, 2686, 372, 226],
            details: [
                { name: 'DIESEL S10', count: 381, liters: '52.506', value: '339.505' },
                { name: 'DIESEL S10 ADITIVADA', count: 11, liters: '2.683', value: '17.141' },
                { name: 'ARLA', count: 118, liters: '2.686', value: '10.979' },
                { name: 'DIESEL S10 ADITIVADO', count: 1, liters: '372', value: '2.379' },
                { name: 'DIESEL COMUM', count: 3, liters: '226', value: '1.508' },
            ]
        },
        fuelVehiclesValue: { labels: ["GFL3G04", "GDY0H87", "UGA2B60", "EHJ0E76", "FET3H45", "NAW6C82", "CFD4B98", "NAW6I81", "EXV3F24", "QSQ3D59"], data: [45847, 40426, 35055, 27683, 25370, 22582, 19425, 19114, 17978, 12877] },
        fuelVehiclesLiters: { labels: ["GFL3G04", "GDY0H87", "UGA2B60", "EHJ0E76", "FET3H45", "NAW6C82", "NAW6I81", "CFD4B98", "EXV3F24", "QSQ3D59"], data: [7335, 6814, 5501, 4576, 3823, 3406, 3066, 2963, 2721, 2048] },
    },
};
...
const PEDAGIO_MONTHLY_DATA = [
    ...
    { placa: 'UGA2B60', mes: 'feb', total: 3585.13, passagens: 121, empresaPedagio: 'SEM PARAR;VELOE TAG' },
    { placa: 'ELY9J91', mes: 'feb', total: 2323.76, passagens: 226, empresaPedagio: 'SEM PARAR' },
    { placa: 'GFL3G04', mes: 'feb', total: 1695.51, passagens: 33, empresaPedagio: 'SEM PARAR' },
    { placa: 'GDY0H87', mes: 'feb', total: 1624.86, passagens: 36, empresaPedagio: 'SEM PARAR' },
    { placa: 'FET3H45', mes: 'feb', total: 1453.45, passagens: 76, empresaPedagio: 'SEM PARAR' },
    { placa: 'QSQ3D59', mes: 'feb', total: 1437.26, passagens: 83, empresaPedagio: 'SEM PARAR;VELOE TAG' },
    { placa: 'UGQ5H10', mes: 'feb', total: 1377.81, passagens: 74, empresaPedagio: 'SEM PARAR' },
    { placa: 'FPG7G53', mes: 'feb', total: 1289.54, passagens: 63, empresaPedagio: 'SEM PARAR' },
    { placa: 'BXZ3F52', mes: 'feb', total: 1214.6, passagens: 139, empresaPedagio: 'SEM PARAR' },
    { placa: 'FWK8A94', mes: 'feb', total: 1115.79, passagens: 61, empresaPedagio: 'SEM PARAR' },
    { placa: 'CFD4B98', mes: 'feb', total: 1061.57, passagens: 59, empresaPedagio: 'SEM PARAR' },
    { placa: 'STD3J94', mes: 'feb', total: 789.28, passagens: 40, empresaPedagio: 'SEM PARAR' },
    { placa: 'GGW9G47', mes: 'feb', total: 634.05, passagens: 61, empresaPedagio: 'SEM PARAR' },
    { placa: 'EFW6626', mes: 'feb', total: 505.19, passagens: 33, empresaPedagio: 'SEM PARAR' },
    { placa: 'NAW6C82', mes: 'feb', total: 488.0, passagens: 25, empresaPedagio: 'VELOE TAG' },
    { placa: 'EXV3F24', mes: 'feb', total: 332.09, passagens: 17, empresaPedagio: 'SEM PARAR' },
    { placa: 'EFW6601', mes: 'feb', total: 311.9, passagens: 29, empresaPedagio: 'SEM PARAR' },
